...
func TestAdmissionClassifiesReadOnlyCLISubcommands(t *testing.T) {
	for _, command := range []string{
		...
		"agent-ledger integrations drift",
		"agent-ledger integrations lockfile",
		"agent-ledger integrations upgrade-gate",
		"agent-ledger integrations schema-gate",
		"agent-ledger integration-readiness",
		"agent-ledger integration-smoke",
		"agent-ledger integration-drift",
		"agent-ledger integration-lockfile",
		"agent-ledger integration-upgrade-gate",
		"agent-ledger schema-gate --schema-version v1",
		"agent-ledger event schema-gate --schema-version v1",
