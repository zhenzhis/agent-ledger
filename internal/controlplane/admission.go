...
func CLICommandAccessFor(command string, input AdmissionInput) OperationAccess {
	...
	switch parts[0] {
	case "version", "today", "top", "doctor", "battery", "wrapped", "discovery", "contracts", "openapi", "integrations", "integration-readiness", "signals", "signal-taxonomy", "signal-coverage", "goal", "ui", "runtime", "config", "readiness", "admission", "adapter", "agent", "replay", "badge", "preflight", "chargeback", "fleet", "export", "audit", "router":
