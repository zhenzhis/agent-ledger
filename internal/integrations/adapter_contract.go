...
func AdapterContractSpec() AdapterContract {
	return AdapterContract{
		...
		Ingest: AdapterIngestContract{
			...
			MCPTools: []string{"ledger.record_event", "ledger.start_workload", "ledger.start_run", "ledger.heartbeat_run", "ledger.record_tool_call", "ledger.record_context", "ledger.record_artifact", "ledger.record_evaluation"},
		},
