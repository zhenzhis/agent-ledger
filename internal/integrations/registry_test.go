...
func TestContractBundleIndexesCoreContracts(t *testing.T) {
	...
	for _, id := range []string{"discovery", "contract-bundle", "openapi", "capability-catalog", "provider-profiles", "agent-profiles", "integration-recommendation", "runtime-status", "admission-check", "canonical-event-schema", "adapter-contract", "adapter-conformance-matrix", "a2a-discovery"} {
...
func TestOpenAPIEcosystemIngestSchemasExposeTelemetryFields(t *testing.T) {
	...
	expectFields("DiscoveryManifest", "contract_bundle_uri", "openapi_uri", "capability_catalog_hash", "provider_profiles_uri", "provider_profiles_hash", "agent_profiles_uri", "agent_profiles_hash", "integration_recommendation_uri", "integration_recommendation_hash", "conformance_matrix_uri", "conformance_matrix_hash", "runtime_status_uri", "canonical_schema_uri", "canonical_schema_hash", "event_examples_uri", "adapter_spec_uri", "adapter_spec_hash", "adapter_conformance_uri", "a2a")
...
func TestContractVerificationReportIsOKAndPrivacySafe(t *testing.T) {
	...
	for _, name := range []string{"discovery.contract_bundle_uri", "discovery.agent_profiles", "discovery.integration_recommendation", "discovery.conformance_matrix", "discovery.a2a_metadata", "bundle.document.openapi", "bundle.document.agent-profiles", "bundle.document.integration-recommendation", "bundle.document.adapter-conformance-matrix", "bundle.document.a2a-discovery", "canonical.examples", "adapter.schema_alignment", "adapter.input_kinds", "adapter.conformance_matrix", "privacy.public_metadata_language", "openapi.agent_profiles_hash", "openapi.integration_recommendation_hash", "openapi.conformance_matrix_hash", "openapi.path./api/contracts/verify", "openapi.path./api/integrations/recommendation", "openapi.privacy", "openapi.auth_scheme", "openapi.operation_auth", "openapi.operation_ids", "openapi.operation_admission", "openapi.operation_methods", "openapi.request_body_limits", "openapi.idempotency", "openapi.get_revalidation"} {
