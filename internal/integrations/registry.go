...
func Registry(opts Options) Catalog {
	...
	capabilities := []Capability{
		...
		},
		{
			...
			Tools:     []string{"ledger.current_budget", "ledger.discovery", "ledger.contracts", "ledger.contracts_verify", "ledger.goal_coverage", "ledger.openapi", "ledger.runtime_status", "ledger.config_status", "ledger.readiness", "ledger.admission_check", "ledger.start_workload", "ledger.start_run", "ledger.close_workload", "ledger.link_workloads", "ledger.claim_next_workload", "ledger.workload_queue", "ledger.acquire_workload_lease", "ledger.renew_workload_lease", "ledger.release_workload_lease", "ledger.workload_leases", "ledger.heartbeat_run", "ledger.run_liveness", "ledger.workload_timeline", "ledger.workload_state", "ledger.workload_feed", "ledger.record_tool_call", "ledger.record_context", "ledger.record_artifact", "ledger.record_evaluation", "ledger.record_event", "ledger.validate_event", "ledger.event_schema", "ledger.event_examples", "ledger.adapter_contract", "ledger.adapter_conformance", "ledger.conformance_matrix", "ledger.integrations", "ledger.provider_profiles", "ledger.agent_profiles", "ledger.signal_taxonomy", "ledger.signal_coverage", "ledger.integration_readiness", "ledger.integration_smoke", "ledger.integration_compatibility", "ledger.integration_rollout_plan", "ledger.integration_evidence_kit", "ledger.integration_recommendation", "ledger.get_policy", "ledger.policy_audit", "ledger.approval_routes", "ledger.approvals", "ledger.resolve_approval", "ledger.audit_log", "ledger.explain_cost", "ledger.find_similar_workloads"},
			Resources: []string{"agent-ledger://discovery/manifest", "agent-ledger://contracts/bundle", "agent-ledger://contracts/verification", "agent-ledger://goal/coverage", "agent-ledger://contracts/openapi", "agent-ledger://schema/canonical-events", "agent-ledger://schema/canonical-event-examples", "agent-ledger://integrations/catalog", "agent-ledger://integrations/provider-profiles", "agent-ledger://integrations/agent-profiles", "agent-ledger://integrations/signal-taxonomy", "agent-ledger://integrations/signal-coverage", "agent-ledger://integrations/readiness", "agent-ledger://integrations/smoke", "agent-ledger://integrations/compatibility", "agent-ledger://integrations/rollout-plan", "agent-ledger://integrations/evidence-kit", "agent-ledger://integrations/recommendation", "agent-ledger://integrations/adapter-contract", "agent-ledger://integrations/conformance-matrix", "agent-ledger://runtime/status", "agent-ledger://config/status", "agent-ledger://readiness", "agent-ledger://admission/check", "agent-ledger://budget/current", "agent-ledger://workloads/recent", "agent-ledger://workloads/queue", "agent-ledger://workloads/leases", "agent-ledger://workloads/feed", "agent-ledger://workload/state", "agent-ledger://workload/timeline", "agent-ledger://agent-runs/liveness", "agent-ledger://policies/status", "agent-ledger://policy/approvals", "agent-ledger://policy/approval-routes"},
