...
func Registry(opts Options) Catalog {
	...
	capabilities := []Capability{
		...
		},
		{
			...
			Maturity:    "stable-v1",
			Enabled:     true,
			Privacy:     "static provider/runtime metadata only; no API keys, endpoints with secrets, local paths, prompts, responses, sessions, machine names, authors, or usage rows",
