...
func Registry(opts Options) Catalog {
	...
	capabilities := []Capability{
		...
		},
		{
			...
			Resources: []string{"agent-ledger://discovery/manifest", "agent-ledger://contracts/bundle", "agent-ledger://contracts/verification", "agent-ledger://goal/coverage", "agent-ledger://contracts/openapi", "agent-ledger://schema/canonical-events", "agent-ledger://schema/canonical-event-examples", "agent-ledger://integrations/catalog", "agent-ledger://integrations/provider-profiles", "agent-ledger://integrations/agent-profiles", "agent-ledger://integrations/signal-taxonomy", "agent-ledger://integrations/signal-coverage", "agent-ledger://integrations/readiness", "agent-ledger://integrations/smoke", "agent-ledger://integrations/compatibility", "agent-ledger://integrations/rollout-plan", "agent-ledger://integrations/evidence-kit", "agent-ledger://integrations/drift", "agent-ledger://integrations/lockfile", "agent-ledger://integrations/upgrade-gate", "agent-ledger://integrations/recommendation", "agent-ledger://integrations/adapter-contract", "agent-ledger://integrations/conformance-matrix", "agent-ledger://runtime/status", "agent-ledger://config/status", "agent-ledger://readiness", "agent-ledger://admission/check", "agent-ledger://budget/current", "agent-ledger://workloads/recent", "agent-ledger://workloads/queue", "agent-ledger://workloads/leases", "agent-ledger://workloads/feed", "agent-ledger://workload/state", "agent-ledger://workload/timeline", "agent-ledger://agent-runs/liveness", "agent-ledger://policies/status", "agent-ledger://policy/approvals", "agent-ledger://policy/approval-routes"},
