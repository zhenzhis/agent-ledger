...
func OpenAPISpecFor(opts Options, runtime *storage.RuntimeStatus) map[string]interface{} {
	...
	spec := map[string]interface{}{
		...
		"x-agent-ledger": map[string]interface{}{
			...
			"integration_production_gate_hash": IntegrationProductionGateOpenAPIFingerprint(opts, runtime),
		...
		"paths": map[string]interface{}{
			...
			"/api/integrations/production-gate":    integrationProductionGateOperation(),
			...
			"/api/quota/status":                    volatileReadOperation("finops", "Get quota estimate", "Read local 5h/day/week/month/custom quota and burn-rate estimates. Subscription quota is an estimate, not provider billing.", "QuotaStatus", []map[string]interface{}{queryParam("window", "Optional quota window: all, 5h, day, week, month, or a configured custom window."), queryParam("source", "Optional source filter."), queryParam("model", "Optional model filter."), queryParam("project", "Optional project/workspace filter.")}),
			...
			"schemas": map[string]interface{}{
				...
				"DiscoveryManifest": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"api_base_path":                    stringSchema(),
						"well_known_uri":                   stringSchema(),
						"capability_catalog_uri":           stringSchema(),
						"contract_bundle_uri":              stringSchema(),
						"openapi_uri":                      stringSchema(),
						"runtime_status_uri":               stringSchema(),
						...
						"integration_compatibility_uri":    stringSchema(),
						...
						"integration_production_gate_uri":  stringSchema(),
						"integration_production_gate_hash": refSchema("Hash"),
						...
						"canonical_schema_uri":             stringSchema(),
						"canonical_schema_hash":            refSchema("Hash"),
						"event_examples_uri":               stringSchema(),
						"adapter_spec_uri":                 stringSchema(),
						"adapter_spec_hash":                refSchema("Hash"),
						"adapter_conformance_uri":          stringSchema(),
						"mcp_command":                      stringSchema(),
						"auth":                             stringSchema(),
				...
				"IntegrationCompatibilityReport":      integrationCompatibilityReportSchema(),
				"IntegrationCompatibilityRequest":     integrationCompatibilityRequestSchema(),
				"IntegrationCompatibilitySummary":     integrationCompatibilitySummarySchema(),
				"IntegrationCompatibilityRow":         integrationCompatibilityRowSchema(),
				"IntegrationRolloutPlanReport":        integrationRolloutPlanReportSchema(),
				"IntegrationRolloutRequest":           integrationRolloutRequestSchema(),
				"IntegrationRolloutSummary":           integrationRolloutSummarySchema(),
				"IntegrationRolloutTarget":            integrationRolloutTargetSchema(),
				...
				"IntegrationProductionGateReport":     integrationProductionGateReportSchema(),
				"IntegrationProductionGateRequest":    integrationProductionGateRequestSchema(),
				"IntegrationProductionGateHashes":     integrationProductionGateHashesSchema(),
				"IntegrationProductionGateDecision":   integrationProductionGateDecisionSchema(),
				"IntegrationProductionGateSummary":    integrationProductionGateSummarySchema(),
				"IntegrationProductionGateCheck":      integrationProductionGateCheckSchema(),
				...
				"AdapterConformanceMatrix":            adapterConformanceMatrixSchema(),
				"AdapterConformanceSummary":           adapterConformanceSummarySchema(),
				"AdapterConformanceKind":              adapterConformanceKindSchema(),
				"AdapterConformanceFixture":           adapterConformanceFixtureSchema(),
...
func OpenAPIContractPaths() []string {
	return []string{
		...
		"/api/integrations/production-gate",
...
func integrationCompatibilityOperation() map[string]interface{} {
	op := getOperation("contracts", "Get integration compatibility", "Read-only agent/provider compatibility matrix computed from static profiles, conformance metadata, and advisor rules.", "IntegrationCompatibilityReport")
	op["get"].(map[string]interface{})["parameters"] = []map[string]interface{}{
		...
		queryParam("surface", "Force a candidate surface such as canonical-events, provider-envelope, provider-stream, opentelemetry, a2a, mcp-stdio, local-collector, or gateway."),
		queryParam("min_confidence", "Optional minimum confidence from 0.0 to 1.0."),
	}
	return op
}
...
func integrationProductionGateOperation() map[string]interface{} {
	op := getOperation("contracts", "Get integration production gate", "Read-only pass/review/block production enablement gate for readiness, smoke, release evidence, runtime flags, and explicit operator approval.", "IntegrationProductionGateReport")
	op["get"].(map[string]interface{})["parameters"] = []map[string]interface{}{
		boolQueryParam("strict", "Block review-required preview, smoke warning, and outbound posture checks instead of returning review status."),
		boolQueryParam("allow_preview", "Operator has attached deployment smoke evidence and accepts enabled local-preview surfaces."),
		boolQueryParam("allow_outbound", "Operator has attached auth, loopback, redaction, and policy evidence for outbound or receiver surfaces."),
	}
	return op
}
...
func integrationRecommendationOperation() map[string]interface{} {
	op := getOperation("contracts", "Get integration recommendation", "Read-only advisor that maps an agent profile, provider profile, requested surface, and available signals to Agent Ledger ingest, validation, privacy, and quality gates.", "IntegrationRecommendationReport")
	op["get"].(map[string]interface{})["parameters"] = []map[string]interface{}{
		queryParam("agent_profile_id", "Agent framework profile id such as codex-cli. Aliases: agent, profile, framework."),
		queryParam("agent", "Alias for agent_profile_id."),
		queryParam("provider_profile_id", "Provider/runtime profile id such as openai-official. Alias: provider."),
		queryParam("provider", "Alias for provider_profile_id."),
		queryParam("surface", "Requested surface such as local-collector, canonical-events, provider-envelope, provider-stream, opentelemetry, a2a, mcp-stdio, or gateway."),
		queryParam("signals", "Comma-separated available signals such as model,usage,cache."),
		queryParam("runtime_mode", "Optional caller runtime mode label."),
		boolQueryParam("read_only", "Whether the caller is evaluating for observer/read-only mode."),
	}
	return op
}
...
func agentFrameworkProfileCatalogSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static privacy-safe agent CLI, framework, wrapper, router, protocol, and observability profile catalog.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "privacy_policy", "summary", "profiles", "quality_gates", "routing_guidance"},
		"properties": map[string]interface{}{
			"product":            stringSchema(),
			"contract":           constSchema("agent-ledger.agent-framework-profile-catalog"),
			"version":            stringSchema(),
			"generated_from":     stringSchema(),
			"local_first":        boolSchema(),
			"read_only_safe":     boolSchema(),
			"writes_local_state": boolSchema(),
			"privacy_policy":     stringSchema(),
			"summary":            refSchema("AgentFrameworkSummary"),
			"profiles":           refArraySchema("AgentFrameworkProfile"),
			"quality_gates":      stringArraySchema(),
			"routing_guidance":   stringArraySchema(),
		},
	}
...
func agentFrameworkSummarySchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Agent CLI, framework, wrapper, router, protocol, and observability profile coverage counts.",
		"additionalProperties": true,
		"required": []string{
			"profiles", "local_collectors", "canonical_event_ingest", "provider_envelope_ingest", "provider_stream_ingest", "mcp_tooling", "a2a_telemetry", "otel_telemetry", "workload_heartbeats", "multi_agent_routers",
		},
		"properties": map[string]interface{}{
			"profiles":                 integerSchema(),
			"local_collectors":         integerSchema(),
			"canonical_event_ingest":   integerSchema(),
			"provider_envelope_ingest": integerSchema(),
			"provider_stream_ingest":   integerSchema(),
			"mcp_tooling":              integerSchema(),
			"a2a_telemetry":            integerSchema(),
			"otel_telemetry":           integerSchema(),
			"workload_heartbeats":      integerSchema(),
			"multi_agent_routers":      integerSchema(),
		},
	}
}

func agentFrameworkProfileSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One agent CLI, framework, wrapper, router, protocol adapter, or observability bridge profile. This schema carries metadata only and never includes prompts, responses, raw local paths, or secrets.",
		"additionalProperties": true,
		"required":             []string{"id", "label", "kind", "families", "supported_surfaces", "recommended_ingest", "available_signals", "canonical_event_types", "privacy_notes", "quality_gates"},
		"properties": map[string]interface{}{
			"id":                    stringSchema(),
			"label":                 stringSchema(),
			"kind":                  stringSchema(),
			"families":              stringArraySchema(),
			"supported_surfaces":    stringArraySchema(),
			"recommended_ingest":    stringSchema(),
			"fallback_ingest":       stringArraySchema(),
			"available_signals":     stringArraySchema(),
			"canonical_event_types": stringArraySchema(),
			"collector_sources":     stringArraySchema(),
			"adapter_input_kinds":   stringArraySchema(),
			"mcp_tools":             stringArraySchema(),
			"mcp_resources":         stringArraySchema(),
			"http_endpoints":        stringArraySchema(),
			"cli_commands":          stringArraySchema(),
			"privacy_notes":         stringArraySchema(),
			"quality_gates":         stringArraySchema(),
			"limitations":           stringArraySchema(),
		},
...
func integrationCompatibilityReportSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static privacy-safe agent/provider compatibility matrix for ecosystem adapter rollout.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "privacy_policy", "request", "agent_profiles_hash", "provider_profiles_hash", "integration_recommendation_hash", "conformance_matrix_hash", "canonical_schema_hash", "compatibility_hash", "summary", "rows", "quality_gates", "operational_guidance"},
		"properties": map[string]interface{}{
			"product":                         stringSchema(),
			"contract":                        constSchema("agent-ledger.integration-compatibility"),
			"version":                         stringSchema(),
			"local_first":                     boolSchema(),
			"read_only_safe":                  boolSchema(),
			"writes_local_state":              boolSchema(),
			"privacy_policy":                  stringSchema(),
			"request":                         refSchema("IntegrationCompatibilityRequest"),
			"agent_profiles_hash":             refSchema("Hash"),
			"provider_profiles_hash":          refSchema("Hash"),
			"integration_recommendation_hash": refSchema("Hash"),
			"conformance_matrix_hash":         refSchema("Hash"),
			"canonical_schema_hash":           refSchema("Hash"),
			"compatibility_hash":              refSchema("Hash"),
			"summary":                         refSchema("IntegrationCompatibilitySummary"),
			"rows":                            refArraySchema("IntegrationCompatibilityRow"),
			"quality_gates":                   stringArraySchema(),
			"operational_guidance":            stringArraySchema(),
		},
	}
...
func integrationCompatibilityRequestSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static compatibility matrix filters.",
		"additionalProperties": true,
		"properties": map[string]interface{}{
...
func integrationCompatibilitySummarySchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Compatibility matrix rollout counts.",
		"additionalProperties": true,
		"required":             []string{"agent_profiles", "provider_profiles", "rows", "ready", "review_required", "limited", "high_confidence", "strict_ci_available", "local_only_surfaces", "outbound_surfaces", "unpriced_risk_profiles"},
		"properties": map[string]interface{}{
			"agent_profiles":         integerSchema(),
			"provider_profiles":      integerSchema(),
			"rows":                   integerSchema(),
			"ready":                  integerSchema(),
			"review_required":        integerSchema(),
			"limited":                integerSchema(),
			"high_confidence":        integerSchema(),
			"strict_ci_available":    integerSchema(),
			"local_only_surfaces":    integerSchema(),
			"outbound_surfaces":      integerSchema(),
			"unpriced_risk_profiles": integerSchema(),
		},
	}
}

func integrationCompatibilityRowSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One agent/provider compatibility row.",
		"additionalProperties": true,
		"required":             []string{"agent_profile_id", "agent_label", "provider_profile_id", "provider_label", "recommended_surface", "candidate_surfaces", "status", "risk_level", "confidence", "strict_ci", "validation", "expected_event_types", "required_signals", "compatibility_reasons", "next_steps"},
		"properties": map[string]interface{}{
			"agent_profile_id":      stringSchema(),
			"agent_label":           stringSchema(),
			"provider_profile_id":   stringSchema(),
			"provider_label":        stringSchema(),
			"recommended_surface":   stringSchema(),
			"candidate_surfaces":    stringArraySchema(),
			"status":                stringSchema(),
			"risk_level":            stringSchema(),
			"confidence":            numberSchema(),
			...
			"expected_event_types":  stringArraySchema(),
			"required_signals":      stringArraySchema(),
			"conformance_kinds":     stringArraySchema(),
			"compatibility_reasons": stringArraySchema(),
			"limitations":           stringArraySchema(),
...
func integrationRolloutPlanReportSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static privacy-safe adapter rollout checklist.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "privacy_policy", "request", "compatibility_hash", "integration_recommendation_hash", "conformance_matrix_hash", "canonical_schema_hash", "rollout_hash", "summary", "target", "phases", "fixtures", "release_gates", "rollback_plan", "operational_guidance"},
		"properties": map[string]interface{}{
			"product":                         stringSchema(),
			"contract":                        constSchema("agent-ledger.integration-rollout-plan"),
			"version":                         stringSchema(),
			"local_first":                     boolSchema(),
			"read_only_safe":                  boolSchema(),
			"writes_local_state":              boolSchema(),
			"privacy_policy":                  stringSchema(),
			"request":                         refSchema("IntegrationRolloutRequest"),
			"compatibility_hash":              refSchema("Hash"),
			"integration_recommendation_hash": refSchema("Hash"),
			"conformance_matrix_hash":         refSchema("Hash"),
			"canonical_schema_hash":           refSchema("Hash"),
			"rollout_hash":                    refSchema("Hash"),
			"summary":                         refSchema("IntegrationRolloutSummary"),
			"target":                          refSchema("IntegrationRolloutTarget"),
			"phases":                          refArraySchema("IntegrationRolloutPhase"),
			"fixtures":                        refArraySchema("IntegrationRolloutFixture"),
			"release_gates":                   stringArraySchema(),
			"rollback_plan":                   stringArraySchema(),
			"operational_guidance":            stringArraySchema(),
		},
	}
}

func integrationRolloutRequestSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static rollout plan filters.",
		"additionalProperties": true,
		"properties": map[string]interface{}{
			"agent_profile_id":    stringSchema(),
			"provider_profile_id": stringSchema(),
...
func integrationRolloutSummarySchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Rollout checklist counts.",
		"additionalProperties": true,
		"required":             []string{"status", "phases", "steps", "required_steps", "strict_fixtures", "admission_checks", "release_gates", "warnings", "requires_pricing_override", "requires_outbound_review"},
		"properties": map[string]interface{}{
			"status":                    stringSchema(),
			"phases":                    integerSchema(),
			"steps":                     integerSchema(),
			"required_steps":            integerSchema(),
			"strict_fixtures":           integerSchema(),
			"admission_checks":          integerSchema(),
			"release_gates":             integerSchema(),
			"warnings":                  integerSchema(),
			"requires_pricing_override": boolSchema(),
			"requires_outbound_review":  boolSchema(),
		},
	}
}

func integrationRolloutTargetSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Selected rollout target.",
		"additionalProperties": true,
		"required":             []string{"agent_profile_id", "agent_label", "provider_profile_id", "provider_label", "surface", "status", "risk_level", "confidence", "candidate_surfaces", "expected_event_types", "required_signals"},
		"properties": map[string]interface{}{
			"agent_profile_id":     stringSchema(),
			"agent_label":          stringSchema(),
			"provider_profile_id":  stringSchema(),
...
func integrationRolloutPhaseSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One rollout checklist phase.",
		"additionalProperties": true,
		"required":             []string{"id", "title", "purpose", "required", "status", "steps"},
		"properties": map[string]interface{}{
			"id":       stringSchema(),
			"title":    stringSchema(),
			"purpose":  stringSchema(),
			"required": boolSchema(),
			"status":   stringSchema(),
			"steps":    refArraySchema("IntegrationRolloutStep"),
		},
	}
}

func integrationRolloutStepSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One rollout checklist step.",
		"additionalProperties": true,
		"required":             []string{"id", "title", "required", "gate", "privacy"},
		"properties": map[string]interface{}{
			"id":       stringSchema(),
			"title":    stringSchema(),
			"command":  stringSchema(),
...
func integrationRolloutFixtureSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Repository-relative rollout fixture declaration.",
		"additionalProperties": true,
		"required":             []string{"conformance_kind", "path", "format", "scenario", "strict", "command", "expected_event_types", "privacy"},
		"properties": map[string]interface{}{
			"conformance_kind":     stringSchema(),
			"path":                 stringSchema(),
			"format":               stringSchema(),
...
func integrationProductionGateReportSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static privacy-safe production enablement gate report.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "privacy_policy", "request", "gate_hash", "hashes", "runtime", "decision", "summary", "checks", "ci_commands", "required_artifacts", "operational_guidance", "redaction_rules"},
		"properties": map[string]interface{}{
			"product":              stringSchema(),
			"contract":             constSchema("agent-ledger.integration-production-gate"),
			"version":              stringSchema(),
			"local_first":          boolSchema(),
			"read_only_safe":       boolSchema(),
			"writes_local_state":   boolSchema(),
			"privacy_policy":       stringSchema(),
			"request":              refSchema("IntegrationProductionGateRequest"),
			"gate_hash":            refSchema("Hash"),
			"hashes":               refSchema("IntegrationProductionGateHashes"),
			"runtime":              refSchema("IntegrationSmokeRuntime"),
			"decision":             refSchema("IntegrationProductionGateDecision"),
			"summary":              refSchema("IntegrationProductionGateSummary"),
			"checks":               refArraySchema("IntegrationProductionGateCheck"),
			"ci_commands":          stringArraySchema(),
			"required_artifacts":   stringArraySchema(),
			"operational_guidance": stringArraySchema(),
			"redaction_rules":      stringArraySchema(),
...
func integrationProductionGateRequestSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Operator intent for production enablement review.",
		"additionalProperties": true,
		"properties": map[string]interface{}{
			"strict":         boolSchema(),
			"allow_preview":  boolSchema(),
			"allow_outbound": boolSchema(),
		},
	}
}

func integrationProductionGateHashesSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Stable hashes pinned by the production gate.",
		"additionalProperties": true,
		"required":             []string{"capability_catalog_hash", "integration_readiness_hash", "integration_smoke_hash", "integration_upgrade_gate_hash", "integration_evidence_kit_hash", "openapi_smoke_hash", "runtime_status_hash"},
		"properties": map[string]interface{}{
			"capability_catalog_hash":       refSchema("Hash"),
			"integration_readiness_hash":    refSchema("Hash"),
			"integration_smoke_hash":        refSchema("Hash"),
...
func integrationProductionGateDecisionSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "CI-friendly production gate decision.",
		"additionalProperties": true,
		"required":             []string{"status", "severity", "reason", "recommended_ci_exit_code", "allow_production_enablement", "requires_human_review", "requires_smoke"},
		"properties": map[string]interface{}{
			"status":                      stringSchema(),
			"severity":                    stringSchema(),
			"reason":                      stringSchema(),
			"recommended_ci_exit_code":    integerSchema(),
			"allow_production_enablement": boolSchema(),
			"requires_human_review":       boolSchema(),
			"requires_smoke":              boolSchema(),
		},
	}
}

func integrationProductionGateSummarySchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Production gate count summary.",
		"additionalProperties": true,
		"required":             []string{"total_checks", "passed", "review", "blocked", "smoke_warnings", "smoke_failures", "readiness_blocked", "readiness_review_required", "preview_enabled", "outbound_enabled", "write_enabled", "disabled_by_config", "recommended_ci_exit_code"},
		"properties": map[string]interface{}{
			"total_checks":              integerSchema(),
			"passed":                    integerSchema(),
			"review":                    integerSchema(),
			"blocked":                   integerSchema(),
			"smoke_warnings":            integerSchema(),
			"smoke_failures":            integerSchema(),
			"readiness_blocked":         integerSchema(),
			"readiness_review_required": integerSchema(),
			"preview_enabled":           integerSchema(),
			"outbound_enabled":          integerSchema(),
			"write_enabled":             integerSchema(),
			"disabled_by_config":        integerSchema(),
			"recommended_ci_exit_code":  integerSchema(),
		},
	}
...
func integrationProductionGateCheckSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One production gate check.",
		"additionalProperties": true,
		"required":             []string{"id", "status", "severity", "message", "evidence", "remediation", "privacy"},
		"properties": map[string]interface{}{
			"id":          stringSchema(),
...
func integrationRecommendationRequestSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Read-only integration advisor request for wrappers, routers, and adapter CI.",
		"additionalProperties": true,
		"properties": map[string]interface{}{
			"agent_profile_id":    stringSchema(),
			"provider_profile_id": stringSchema(),
			...
			"runtime_mode":        stringSchema(),
			"read_only":           boolSchema(),
		},
	}
}

func integrationRecommendationProfileRefSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Compact references to the static catalogs used by a recommendation report.",
		"additionalProperties": true,
		"properties": map[string]interface{}{
			"agent_profile_ids":    stringArraySchema(),
			"provider_profile_ids": stringArraySchema(),
...
func integrationRecommendationReportSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Deterministic metadata-only recommendation report for choosing Agent Ledger ingest and validation surfaces.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "request", "recommended_surface", "recommendation", "confidence", "hashes", "privacy_checklist", "quality_gates", "next_steps"},
		"properties": map[string]interface{}{
			"product":                  stringSchema(),
			"contract":                 constSchema("agent-ledger.integration-recommendation"),
			"version":                  stringSchema(),
			"local_first":              boolSchema(),
			"read_only_safe":           boolSchema(),
			"writes_local_state":       boolSchema(),
			"privacy_policy":           stringSchema(),
			"request":                  refSchema("IntegrationRecommendationRequest"),
			"matched_agent_profile":    refSchema("AgentFrameworkProfile"),
			"matched_provider_profile": refSchema("ProviderProfile"),
			"recommended_surface":      stringSchema(),
			"recommendation":           stringSchema(),
			"confidence":               numberSchema(),
			"ingest_path":              stringSchema(),
			"fallback_paths":           stringArraySchema(),
			...
			"privacy_checklist":        stringArraySchema(),
			"quality_gates":            stringArraySchema(),
			"limitations":              stringArraySchema(),
			"hashes":                   stringMapSchema(),
			"next_steps":               stringArraySchema(),
			"related_profiles":         refSchema("IntegrationRecommendationProfileRef"),
		},
	}
}

func adapterConformanceMatrixSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Static privacy-safe adapter conformance matrix for wrappers, routers, adapter CI, and provider/runtime integrations.",
		"additionalProperties": true,
		"required":             []string{"product", "contract", "version", "local_first", "read_only_safe", "writes_local_state", "schema_hash", "adapter_spec_hash", "provider_profiles_hash", "privacy_policy", "summary", "kinds", "quality_gates", "routing_guidance"},
		"properties": map[string]interface{}{
			"product":                stringSchema(),
			"contract":               constSchema("agent-ledger.adapter-conformance-matrix"),
			"version":                stringSchema(),
			"local_first":            boolSchema(),
			"read_only_safe":         boolSchema(),
			"writes_local_state":     boolSchema(),
			...
			"provider_profiles_hash": refSchema("Hash"),
			"privacy_policy":         stringSchema(),
			"summary":                refSchema("AdapterConformanceSummary"),
			"kinds":                  refArraySchema("AdapterConformanceKind"),
			"quality_gates":          stringArraySchema(),
			"routing_guidance":       stringArraySchema(),
		},
	}
...
func adapterConformanceSummarySchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "Adapter conformance fixture and kind counts.",
		"additionalProperties": true,
		"required":             []string{"input_kinds", "fixtures", "strict_fixtures", "provider_fixtures", "provider_stream_fixtures", "otel_fixtures", "a2a_fixtures", "canonical_fixtures"},
		"properties": map[string]interface{}{
			"input_kinds":              integerSchema(),
			"fixtures":                 integerSchema(),
			"strict_fixtures":          integerSchema(),
...
func adapterConformanceKindSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One supported adapter conformance input family.",
		"additionalProperties": true,
		"required":             []string{"kind", "conformance_kind", "description", "status", "maturity", "endpoint", "cli_command", "mcp_tool", "strict_ci_command", "accepted_formats", "required_signals", "privacy_notes", "expected_event_types", "fixtures"},
		"properties": map[string]interface{}{
			"kind":                 stringSchema(),
			"conformance_kind":     stringSchema(),
			"description":          stringSchema(),
			...
			"maturity":             stringSchema(),
			"endpoint":             stringSchema(),
			"cli_command":          stringSchema(),
			"mcp_tool":             stringSchema(),
			"strict_ci_command":    stringSchema(),
			"convert_command":      stringSchema(),
			"ingest_command":       stringSchema(),
			"accepted_formats":     stringArraySchema(),
			"required_signals":     stringArraySchema(),
			"privacy_notes":        stringArraySchema(),
			"expected_event_types": stringArraySchema(),
			"fixtures":             refArraySchema("AdapterConformanceFixture"),
		},
	}
}

func adapterConformanceFixtureSchema() map[string]interface{} {
	return map[string]interface{}{
		"type":                 "object",
		"description":          "One privacy-safe adapter conformance fixture.",
		"additionalProperties": true,
		"required":             []string{"path", "format", "scenario", "strict", "command", "expected_event_types", "privacy"},
		"properties": map[string]interface{}{
			"path":                 stringSchema(),
			"format":               stringSchema(),
			"scenario":             stringSchema(),
...
func quotaWindowSchema() map[string]interface{} {
	return map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"prompt_limit":              integerSchema(),
			"remaining_cost":            numberSchema(),
			"remaining_tokens":          integerSchema(),
			"remaining_prompts":         integerSchema(),
			"burn_rate_per_hour":        numberSchema(),
			"token_burn_rate_per_hour":  numberSchema(),
			"prompt_burn_rate_per_hour": numberSchema(),
			"projected_cost_usd":        numberSchema(),
			"projected_tokens":          integerSchema(),
			"projected_prompts":         integerSchema(),
