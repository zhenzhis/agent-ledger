		...
		"components": map[string]interface{}{
			...
			"schemas": map[string]interface{}{
				...
				"DiscoveryManifest": map[string]interface{}{
					...
					"required":             []string{"contract", "version", "local_first", "contract_bundle_uri", "capability_catalog_hash", "provider_profiles_uri", "provider_profiles_hash", "agent_profiles_uri", "agent_profiles_hash", "conformance_matrix_uri", "conformance_matrix_hash", "canonical_schema_hash", "adapter_spec_hash", "a2a"},
