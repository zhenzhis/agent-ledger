...
| `POST /v1/traces` | Optional local OTLP HTTP JSON/protobuf traces receiver when `integrations.otlp_receiver.enabled` is true; responses include backpressure headers for body/span limits |
